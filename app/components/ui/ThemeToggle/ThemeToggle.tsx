...
export default function ThemeToggle() {
  ...
  return (
    <section className="relative flex items-center w-30 h-10 bg-zinc-900 rounded-3xl cursor-pointer">
      <section className="relative flex w-full justify-between px-3">
        <div className={`absolute top-[-4] w-15 h-10 rounded-3xl ${theme === "dark" ? "right-[-2] bg-blue-900/80" : "left-[-2] bg-yellow-400/80"}`}></div>
