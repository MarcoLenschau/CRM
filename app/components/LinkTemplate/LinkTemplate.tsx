...
/**
 * Navigation link component with icon and active state indicator based on current route.
 * Renders as a Next.js Link with visual feedback for the active page and embedded SVG icons.
 *
 * @param name - Display name of the navigation link and route identifier (e.g., "Dashboard", "Customers", "Users")
 * @return Rendered navigation link with icon and active state styling
 * @throws Error if usePathname hook fails; handled by Next.js navigation
 * @category Feature Components
 * @security Client-side routing via Next.js Link component; no sensitive data exposed
 * @performance Uses usePathname hook for efficient active state detection; SVG icons embedded inline
