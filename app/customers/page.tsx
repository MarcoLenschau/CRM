...
function TableActions({ customerId, customerName, onDelete }: { customerId: number; customerName: string; onDelete: (id: number, name: string) => void }) {
  return (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <StatCard 
                ...
                color="bg-gradient-to-br from-blue-900/40 to-blue-800/20 border-blue-700/50"
              />
              <StatCard 
                title="Active"
                count={activeCount}
                color="bg-gradient-to-br from-green-900/40 to-green-800/20 border-green-700/50"
              />
              <StatCard 
                title="Pending"
                count={pendingCount}
                color="bg-gradient-to-br from-yellow-900/40 to-yellow-800/20 border-yellow-700/50"
              />
              <StatCard 
                title="Inactive"
                count={inactiveCount}
                color="bg-gradient-to-br from-red-900/40 to-red-800/20 border-red-700/50"
              />
            </div>
